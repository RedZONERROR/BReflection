...
import red.blackreflection.BlackReflectionInfo;
import red.blackreflection.utils.ClassUtils;
...
public class BlackReflectionProxy {
    ...
    private static final ClassName BR = ClassName.get("red.blackreflection", "BlackReflection");
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return red.blackreflection.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
